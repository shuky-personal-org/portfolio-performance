...
- **Demo portfolio:** **[`demo/demo.portfolio`](demo/demo.portfolio)** is a small synthetic portfolio for local API/UI/web testing. Set **`PORTFOLIO_DIR`** to **`demo/`** or copy/symlink it into your runtime-only **`portfolios/`** directory; see **[`demo/README.md`](demo/README.md)**.
